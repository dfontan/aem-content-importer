...
@org.apache.felix.scr.annotations.Properties({
	@Property(name = Constants.SERVICE_DESCRIPTION, value = "Adobe - DITA XSLT Transformer 2 Service"),
	@Property(name = Constants.SERVICE_VENDOR, value = "Adobe") })
public class DITATransformerXSLT_2Impl implements XMLTransformer, URIResolver {
