...
public class TransformerWorkflowProcess implements WorkflowProcess {
        ...
        if (workflowData.getPayloadType().equals("JCR_PATH")) {
            ...
            try {
                ...
                if (node != null) {
                    ...
                    overrideConfigParam(configFile, meta);
     ...
     * overrideConfigParam
     *
     * @param configProp config properties
     * @param meta meta data map
     * @return Properties
     */
    private Properties overrideConfigParam(Properties configProp, MetaDataMap meta) {
