...
public class ImporterException extends Exception {
    ...
    public ImporterException(AEM_IMPORTER_EXCEPTION_TYPE type, String message) {
        this.type = type;
        this.msg = message;
    }

    public ImporterException(AEM_IMPORTER_EXCEPTION_TYPE type, String message, Exception e) {
        this.type = type;
        this.msg = message;
        this.exception = e;
    }
