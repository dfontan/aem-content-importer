...
public class AemImporterException extends Exception {
	...
	public AemImporterException(AEM_IMPORTER_EXCEPTION_TYPE type, String message) {
		this.type = type;
		this.msg = message;
	}
	
	public AemImporterException(AEM_IMPORTER_EXCEPTION_TYPE type, String message, Exception e) {
		this.type = type;
		this.msg = message;
		this.exception = e;
	}
