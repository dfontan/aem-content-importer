...
//Print heading
//$OutputBuffers[$OUTPUT_HEADING] .= "<div class=\"searchheading\"><h1>" . $queryForHTML . " <span class=\"resultsTotal\">" . PrintNumResults($matches) . " " . $STR_SUMMARY_FOUND . "</span></h1>";
if ($UseCats)
{
	if ($cat[0] == -1)
	{
...
elseif ($NumSearchWords > 1 && $and == 1) //AND
	...
	// heading output here
	$OutputBuffers[$OUTPUT_HEADING] .= "<div class=\"searchheading\"><h1>" . $queryForHTML . " <span class=\"resultsTotal\">" . PrintNumResults($matches) . " " . $STR_SUMMARY_FOUND . "</span></h1>";
	$OutputBuffers[$OUTPUT_HEADING] .= "</div>\n";
...
if ($num_pages > 1)
{
	...
	//page number output
	$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<div class=\"result_pages\"><strong>\n" . $STR_RESULT_PAGES . "</strong> ";
	if ($page > 1)
		$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;zoom_page=".($page-1)."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\"><img src=\"/t2/help/css/img/larr.png\"></a> ";
	for ($i = $start_range; $i <= $end_range; $i++)
	{
		if ($i == $page)
			$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;zoom_page=".($i)."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\"><span class=\"search-page\">(" . $page . ")</span></a>";
		else
	...
	if ($page != $num_pages)
		$OutputBuffers[$OUTPUT_PAGENUMBERS] .= "<a href=\"".$SelfURL.$LinkBackJoinChar."zoom_query=".$queryForURL.$metaParams."&amp;zoom_page=".($page+1)."&amp;zoom_per_page=".$per_page.$query_zoom_cats."&amp;zoom_and=".$and."&amp;zoom_sort=".$sort."\">" . " <img src=\"/t2/help/css/img/rarr.png\"></a> ";
